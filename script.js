...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>chandru</a>.</span><br><br>I am a Computer Engineering student at <span class='bold'>Mangalore Institute of Technology and Engineering👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing a B.Tech degree in IT .<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C<br>PHP<br>Kotlin<br>Dart<br><br>CSS<br>HTML<br>JavaScript</span><br><br>I am well versed with following frameworks :<span class='bold'><br>Android<br>Flutter<br>ReactJs</span><br>");
            break;

        case "education":
            sendTextMessage("I am currently pursuing a B.Tech degree in IT from muthayammal engineering college<br>Passing Year : 2025<br><br>I have completed my PU from Excellent PU College Moodabidri<br>Passing Year:2019<br>Result:94%<br><br>I have completed my Secondary school from local school known as M K Shetty<br>Passing Year:2017");
            break;
        ...
        case "website":
            sendTextMessage("You can check my website here <a target='_blank' href='https://varshithvhegde.github.io/'>chandru</a>");
            break;
        case "blog":
            sendTextMessage("You can check my blog here <a target='_blank' href='https://varshithvhegde.github.io/hugo-blog'>chandru</a>");
            break;
        
        case "github":
            sendTextMessage("You can check my github here <a target='_blank' href='https://github.com/Varshithvhegde'>chandru</a>");
            break;
        case "linkedin":
            sendTextMessage("You can check my linkedin here <a target='_blank' href='https://www.linkedin.com/in/chandru-k-929706233'>chandru</a>");
            break;
        case "friends":
        case "friend":
        ...
        default:
            ...
            sendTextMessage("worng input plese try agin")
            break;
    }
